      ...
      <div className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-[340px]">
          <div className="text-center mb-7">
            ...
            <p className="text-[13px] mt-1" style={{ color: 'var(--color-text-secondary)' }}>Accédez à votre espace MonGaragiste</p>
          </div>
          ...
          <div className="rounded-xl p-6" style={{ background: 'var(--color-background-primary)', border: '0.5px solid var(--color-border-tertiary)' }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              {error && (
                <div className="text-[12px] px-3 py-2 rounded-lg" style={{ background: '#FCEBEB', color: '#A32D2D' }}>{error}</div>
              )}
              <div>
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <Link href="/forgot-password" className="text-[11px]" style={{ color: '#1D9E75' }}>Oublié ?</Link>
                </div>
